...
abstract class AbstractGenerator {
    ...
    AbstractGenerator(final ContextImpl context, final String message, final int threadPoolSize) {
    ...
    AbstractGenerator(final ContextImpl context, final String message) {
